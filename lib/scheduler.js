...
const initScheduler = () => {
  ...
  cron.schedule("59 23 * * *", async () => {
    ...
    try {
      ...
      // Fetch Sales and Purchases models dynamically
      ...
      const emailHtml = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e5e7eb; border-radius: 12px; background-color: #ffffff;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            ...
            <tr>
              <td style="padding: 10px; border: 1px solid #e5e7eb; color: #10b981;">Total Revenue (Sales)</td>
            ...
            <tr>
              ...
              <td style="text-align: right; padding: 10px; border: 1px solid #e5e7eb; font-weight: bold; color: #ef4444;">$${totalPurchasesCost.toLocaleString(undefined, { minimumFractionDigits: 2 })}</td>
            </tr>
